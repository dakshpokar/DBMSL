...
create or replace trigger before_delete_statement_level after delete on Student3160
AS insert into Alumni3160 values(rollno, name, doa, branch, percent, status) select d.rollno, d.name, d.doa, d.branch, d.percent, d.status FROM Deleted d
